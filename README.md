...
<table>
    <tbody>
        <tr>
            <td><img src="https://cdn.icon-icons.com/icons2/1508/PNG/512/python_104451.png" alt="python" style="height: 3rem; min-width: 80px"/></td>
        ...
        <tr>
            <td><img src="https://img.icons8.com/external-bearicons-blue-bearicons/512/external-SQL-file-extension-bearicons-blue-bearicons.png" alt="sql" style="height: 3rem"/></td>
        ...
        <tr>
            <td><img src="https://upload.wikimedia.org/wikipedia/commons/3/35/Tux.svg" alt="metabase" style="height: 3rem"/></td>
        ...
        <tr>
            <td><img src="https://upload.wikimedia.org/wikipedia/commons/3/3f/Git_icon.svg" alt="metabase" style="height: 3rem"/></td>
        ...
        <tr>
            <td><img src="https://img.icons8.com/color/512/docker.png" alt="docker" style="height: 3rem"/></td>
            <td><strong>Docker :</strong><br> Dockerfile, docker-compose, DockerHub, interconnection de containers.</td>
        </tr>
        <tr>
            <td><img src="https://www.sophos.com/sites/default/files/2022-02/googlecloud.png" alt="metabase" style="height: 3rem"/></td>
        ...
        <tr>
            <td><img src="https://ignos.blog/wp-content/uploads/2022/06/apachesparklogo-e1655475818894.png" alt="spark" style="height: 3rem"/></td>
            <td><strong>Airflow :</strong><br> Local, Docker & GCP Composer, DAGs, GCP Operators (BigQuery & Storage).</td>
        </tr>
        <tr>
            <td><img src="https://icons-for-free.com/iconfiles/png/512/apache+kafka-1331550886393441357.png" alt="kafka" style="height: 3rem"/></td>
